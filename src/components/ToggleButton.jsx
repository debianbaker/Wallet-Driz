...
export const ToggleButton = () => {
  ...
  return (
    <div className="flex justify-end ">
      <button
        onClick={() => setTheme(Cookies.get('theme') != 'dark' ? "dark" : "light")}
        type="button"
        class="ml-4 sm:ml-0 ring-2 ring-gray-900/5 shadow-sm hover:bg-gray-50 dark:ring-0 dark:bg-gray-800 dark:hover:bg-gray-700 dark:shadow-highlight/4 group 
        focus:outline-none focus-visible:ring-2 rounded-md focus-visible:ring-sky-500 dark:focus-visible:ring-2 dark:focus-visible:ring-gray-400"
      >
        <span class="sr-only">
        ...
        <svg
          ...
          class="stroke-blue-500 fill-sky-100 group-hover:stroke-blue-600 dark:stroke-gray-400 dark:fill-gray-400/20 dark:group-hover:stroke-gray-300"
        >
